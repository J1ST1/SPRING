...
<body>
	...
	<script>
		...
		//6) 해당 페이지가 코딩되었을 때 아이디중복확인과 관련된 쿠키변수 삭제
		$(function() {
		...
		$("#btn_userid").click(function() {
			...
			//2) //2)입력한 id="btn userid" 값을 변수에 대입하기
			let params = "userid=" + $("#userid").val().trim(); //?변수=값&변수=값
		...
		function checkID(result) {
			...
			//5) 서버에서 응답받은 메시지(result)를 본문의 id=pane]에 출력하고, 쿠키변수에 저장
			//   형식) $.cookie("쿠키변수명", 값)
