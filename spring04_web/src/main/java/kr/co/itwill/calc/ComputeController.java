...
public class ComputeController {
	...
	public ModelAndView diff(@RequestParam("no1") int a, @RequestParam("no2") int b) {
		...
		mav.addObject("img", "<img src='images/logo.jpeg'>");
	...
	//http://localhost:9095/max.do?no2=3&no1=5    	가능
	//http://localhost:9095/max.do?a=3&b=5			에러
	//http://localhost:9095/max.do?no1=3&no2=korea	에러
	...
	public ModelAndView max(int no1, int no2) {
		...
		mav.addObject("result", result);
		mav.addObject("message", "<h3>두 수 중 큰값</h3>");
		mav.addObject("img", "<img src='images/PHOTO1.jpeg'>");
